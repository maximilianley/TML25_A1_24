...
class MetaClassifier(nn.Module):
    def __init__(self, in_dims = 44):
        ...
        self.fc2 = nn.Linear(128, 180)
        self.fc3 = nn.Linear(180, 240)
        self.fc4 = nn.Linear(240, 200)
        self.fc5 = nn.Linear(200, 160)
        self.fc6 = nn.Linear(160, 110)
        #self.bn3 = nn.BatchNorm1d(64)
        #self.dropout3 = nn.Dropout(0.3)
        self.fc7 = nn.Linear(110, 80)
        self.fc8 = nn.Linear(80, 60)
        self.fc9 = nn.Linear(60, 22)
        self.out = nn.Linear(22, 2) # Binary classification: [yes, no] 46_44_64_128_180_150_105_64_32_2
...
while epoch < 130000000:
    ...
    print(f"Epoch {epoch+1}, Avg. Acc.: {(total_acc/len(loader)):.4f}")
    print()
    
    if epoch % 20 == 0:
        command = input("Say 'stop' or continue: ")
        if command == stop:
            epoch = 200000000000000
...
torch.save(meta_model.state_dict(), "./master_linear_10_layers_attempt_8.pt")
