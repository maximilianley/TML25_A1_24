...
class MetaClassifier(nn.Module):
    def __init__(self, in_dims = 44):
        ...
        self.fc3 = nn.Linear(128, 180)
        self.fc4 = nn.Linear(180, 150)
        self.fc5 = nn.Linear(150, 105)
        self.fc6 = nn.Linear(105, 64)
        #self.bn3 = nn.BatchNorm1d(64)
        #self.dropout3 = nn.Dropout(0.3)
        self.fc7 = nn.Linear(64, 32)
        self.out = nn.Linear(32, 2) # Binary classification: [yes, no] 46_44_64_128_180_150_105_64_32_2
...
torch.save(meta_model.state_dict(), "./master_linear_46_44_64_128_180_150_105_64_32_2.pt")
